...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\TenantDevToolsAccessSettings**](TenantDevToolsAccessSettings.md) | The TenantDevToolsAccessSettings object returned by the operation. | [optional]
