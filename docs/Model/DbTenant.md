...
**trusted_domains_enabled** | [**\OpenAPI\Client\Model\TenantTrustedDomainsType**](TenantTrustedDomainsType.md) | The type of the tenant trusted domains. | [optional]
**status** | [**\OpenAPI\Client\Model\TenantStatus**](TenantStatus.md) | The tenant status. | [optional]
...
**industry** | [**\OpenAPI\Client\Model\TenantIndustry**](TenantIndustry.md) | The tenant industry. | [optional]
...
**partner** | [**\OpenAPI\Client\Model\DbTenantPartner**](DbTenantPartner.md) | The database tenant partner parameters. | [optional]
