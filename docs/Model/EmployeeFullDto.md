...
**mobile_phone_activation_status** | [**\OpenAPI\Client\Model\MobilePhoneActivationStatus**](MobilePhoneActivationStatus.md) | The mobile phone activation status. | [optional]
