...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\FolderContentDtoInteger[]**](FolderContentDtoInteger.md) | The list of FolderContentDtoInteger objects returned by the operation. | [optional]
