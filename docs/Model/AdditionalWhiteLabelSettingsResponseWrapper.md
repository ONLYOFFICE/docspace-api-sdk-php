...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\AdditionalWhiteLabelSettings**](AdditionalWhiteLabelSettings.md) | The AdditionalWhiteLabelSettings object returned by the operation. | [optional]
