...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\AuthServiceRequestsDto[]**](AuthServiceRequestsDto.md) | The list of AuthServiceRequestsDto objects returned by the operation. | [optional]
