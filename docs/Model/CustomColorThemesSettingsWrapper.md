...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\CustomColorThemesSettingsDto**](CustomColorThemesSettingsDto.md) | The CustomColorThemesSettingsDto object returned by the operation. | [optional]
