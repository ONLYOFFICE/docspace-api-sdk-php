...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\RoomsNotificationSettingsDto**](RoomsNotificationSettingsDto.md) | The RoomsNotificationSettingsDto object returned by the operation. | [optional]
