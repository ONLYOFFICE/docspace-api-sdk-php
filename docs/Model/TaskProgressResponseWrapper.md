...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\TaskProgressResponseDto**](TaskProgressResponseDto.md) | The TaskProgressResponseDto object returned by the operation. | [optional]
