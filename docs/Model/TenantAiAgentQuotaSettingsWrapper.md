...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\TenantAiAgentQuotaSettings**](TenantAiAgentQuotaSettings.md) | The TenantAiAgentQuotaSettings object returned by the operation. | [optional]
