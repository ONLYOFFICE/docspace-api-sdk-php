...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\GroupMemberSecurityRequestDto[]**](GroupMemberSecurityRequestDto.md) | The list of GroupMemberSecurityRequestDto objects returned by the operation. | [optional]
