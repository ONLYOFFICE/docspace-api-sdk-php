...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\NewItemsDtoFileEntryBaseDto[]**](NewItemsDtoFileEntryBaseDto.md) | The list of NewItemsDtoFileEntryBaseDto objects returned by the operation. | [optional]
