...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\CompanyWhiteLabelSettings[]**](CompanyWhiteLabelSettings.md) | The list of CompanyWhiteLabelSettings objects returned by the operation. | [optional]
