...
**model_settings** | [**\OpenAPI\Client\Model\ModelSettingsItemDto[]**](ModelSettingsItemDto.md) | Optional list of model settings changes to apply atomically with the provider update. | [optional]
