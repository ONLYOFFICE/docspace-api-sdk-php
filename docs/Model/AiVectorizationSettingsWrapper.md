...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\AiVectorizationSettingsDto**](AiVectorizationSettingsDto.md) | The VectorizationSettingsDto object returned by the operation. | [optional]
