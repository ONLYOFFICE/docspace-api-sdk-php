...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\CompanyWhiteLabelSettings**](CompanyWhiteLabelSettings.md) | The CompanyWhiteLabelSettings object returned by the operation. | [optional]
