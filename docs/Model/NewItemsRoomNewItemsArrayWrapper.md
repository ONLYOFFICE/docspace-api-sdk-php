...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\NewItemsDtoRoomNewItemsDto[]**](NewItemsDtoRoomNewItemsDto.md) | The list of NewItemsDtoRoomNewItemsDto objects returned by the operation. | [optional]
