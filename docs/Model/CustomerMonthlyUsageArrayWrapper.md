...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\CustomerMonthlyUsageDto[]**](CustomerMonthlyUsageDto.md) | The list of CustomerMonthlyUsageDto objects returned by the operation. | [optional]
