...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\AiNewItemsDtoAgentNewItemsDto[]**](AiNewItemsDtoAgentNewItemsDto.md) | The list of NewItemsDtoAgentNewItemsDto objects returned by the operation. | [optional]
