...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\FolderContentDtoInteger**](FolderContentDtoInteger.md) | The FolderContentDtoInteger object returned by the operation. | [optional]
