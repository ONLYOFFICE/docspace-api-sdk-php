...
**logo** | [**\OpenAPI\Client\Model\AiLogo**](AiLogo.md) | The folder logo. | [optional]
**pinned** | **bool** | Specifies if the folder is pinned or not. | [optional]
**room_type** | [**\OpenAPI\Client\Model\AiRoomType**](AiRoomType.md) | The room type of the folder. | [optional]
...
**lifetime** | [**\OpenAPI\Client\Model\AiRoomDataLifetimeDto**](AiRoomDataLifetimeDto.md) | The room data lifetime settings of the folder. | [optional]
**watermark** | [**\OpenAPI\Client\Model\AiWatermarkDto**](AiWatermarkDto.md) | The watermark settings of the folder. | [optional]
**type** | [**\OpenAPI\Client\Model\AiFolderType**](AiFolderType.md) | The folder type. | [optional]
...
**chat_settings** | [**\OpenAPI\Client\Model\AiChatSettingsDto**](AiChatSettingsDto.md) | The AI chat settings for the folder room. Contains configuration for AI provider, model selection, and custom prompts.  Only applicable to rooms with AI chat functionality enabled. Null if the room does not have chat settings configured. | [optional]
**root_room_type** | [**\OpenAPI\Client\Model\AiRoomType**](AiRoomType.md) | The room type of the root folder. Indicates the type of the parent room if the current folder is nested within a room hierarchy.  This property helps identify the context in which a nested folder exists. | [optional]
