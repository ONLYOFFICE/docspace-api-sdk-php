...
**created_by** | [**\OpenAPI\Client\Model\EmployeeDto**](EmployeeDto.md) | The user who created the webhook. | [optional]
**created_on** | **\DateTime** | The date and time when the webhook was created. | [optional]
**modified_by** | [**\OpenAPI\Client\Model\EmployeeDto**](EmployeeDto.md) | The user who modified the webhook. | [optional]
