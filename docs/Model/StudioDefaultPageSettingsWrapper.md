...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\StudioDefaultPageSettings**](StudioDefaultPageSettings.md) | The StudioDefaultPageSettings object returned by the operation. | [optional]
