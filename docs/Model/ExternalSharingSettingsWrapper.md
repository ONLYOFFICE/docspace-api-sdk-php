...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\ExternalSharingSettingsDto**](ExternalSharingSettingsDto.md) | The ExternalSharingSettingsDto object returned by the operation. | [optional]
