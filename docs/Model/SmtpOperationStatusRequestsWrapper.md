...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\SmtpOperationStatusRequestsDto**](SmtpOperationStatusRequestsDto.md) | The SmtpOperationStatusRequestsDto object returned by the operation. | [optional]
