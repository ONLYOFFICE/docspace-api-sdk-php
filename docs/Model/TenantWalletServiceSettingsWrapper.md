...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\TenantWalletServiceSettings**](TenantWalletServiceSettings.md) | The TenantWalletServiceSettings object returned by the operation. | [optional]
