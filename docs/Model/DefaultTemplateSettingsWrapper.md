...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\DefaultTemplateSettingsDto**](DefaultTemplateSettingsDto.md) | The DefaultTemplateSettingsDto object returned by the operation. | [optional]
