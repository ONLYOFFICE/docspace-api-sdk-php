...
**default_order** | [**\OpenAPI\Client\Model\OrderBy**](OrderBy.md) | The default order of files. | [optional]
...
**automatically_clean_up** | [**\OpenAPI\Client\Model\AutoCleanUpData**](AutoCleanUpData.md) | The auto-clearing setting parameters. | [optional]
