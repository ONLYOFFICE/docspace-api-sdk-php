...
------------ | ------------- | ------------- | -------------
**storage_type** | [**\OpenAPI\Client\Model\BackupStorageType**](BackupStorageType.md) | The backup storage type. |
**storage_params** | **array<string,string>** | The backup storage parameters. |
**cron_params** | [**\OpenAPI\Client\Model\CronParams**](CronParams.md) | The backup cron parameters. |
