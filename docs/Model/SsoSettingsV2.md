...
**idp_settings** | [**\OpenAPI\Client\Model\SsoIdpSettings**](SsoIdpSettings.md) | The SSO IdP settings. | [optional]
**idp_certificates** | [**\OpenAPI\Client\Model\SsoCertificate[]**](SsoCertificate.md) | The list of the IdP certificates. | [optional]
**idp_certificate_advanced** | [**\OpenAPI\Client\Model\SsoIdpCertificateAdvanced**](SsoIdpCertificateAdvanced.md) | The IdP advanced certificate. | [optional]
...
**sp_certificate_advanced** | [**\OpenAPI\Client\Model\SsoSpCertificateAdvanced**](SsoSpCertificateAdvanced.md) | The SP advanced certificate. | [optional]
**field_mapping** | [**\OpenAPI\Client\Model\SsoFieldMapping**](SsoFieldMapping.md) | The SSO field mapping. | [optional]
