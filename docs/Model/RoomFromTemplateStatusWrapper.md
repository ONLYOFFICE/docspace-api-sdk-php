...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\RoomFromTemplateStatusDto**](RoomFromTemplateStatusDto.md) | The RoomFromTemplateStatusDto object returned by the operation. | [optional]
