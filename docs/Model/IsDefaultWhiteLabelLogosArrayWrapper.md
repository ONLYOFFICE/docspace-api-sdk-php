...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\IsDefaultWhiteLabelLogosDto[]**](IsDefaultWhiteLabelLogosDto.md) | The list of IsDefaultWhiteLabelLogosDto objects returned by the operation. | [optional]
