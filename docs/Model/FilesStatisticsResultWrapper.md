...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\FilesStatisticsResultDto**](FilesStatisticsResultDto.md) | The FilesStatisticsResultDto object returned by the operation. | [optional]
