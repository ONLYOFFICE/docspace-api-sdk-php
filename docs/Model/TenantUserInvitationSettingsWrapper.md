...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\TenantUserInvitationSettingsDto**](TenantUserInvitationSettingsDto.md) | The TenantUserInvitationSettingsDto object returned by the operation. | [optional]
