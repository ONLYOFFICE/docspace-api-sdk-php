...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\TenantUserQuotaSettings**](TenantUserQuotaSettings.md) | The TenantUserQuotaSettings object returned by the operation. | [optional]
