...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\ChunkedUploadSessionResponseInteger**](ChunkedUploadSessionResponseInteger.md) | The ChunkedUploadSessionResponseInteger object returned by the operation. | [optional]
