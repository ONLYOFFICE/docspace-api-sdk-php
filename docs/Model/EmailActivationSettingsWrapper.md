...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\EmailActivationSettings**](EmailActivationSettings.md) | The EmailActivationSettings object returned by the operation. | [optional]
