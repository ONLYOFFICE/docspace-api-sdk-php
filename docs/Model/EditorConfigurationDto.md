...
**embedded** | [**\OpenAPI\Client\Model\EmbeddedConfig**](EmbeddedConfig.md) | The embedded configuration parameters for embedded documents. | [optional]
...
**plugins** | [**\OpenAPI\Client\Model\PluginsConfig**](PluginsConfig.md) | The plugins configuration. | [optional]
...
**user** | [**\OpenAPI\Client\Model\UserConfig**](UserConfig.md) | The user configuration of the editor. | [optional]
