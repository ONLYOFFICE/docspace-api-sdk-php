...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\NotificationChannelStatusDto**](NotificationChannelStatusDto.md) | The NotificationChannelStatusDto object returned by the operation. | [optional]
