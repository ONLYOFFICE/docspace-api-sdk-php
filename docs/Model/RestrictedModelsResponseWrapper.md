...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\RestrictedModelsResponse**](RestrictedModelsResponse.md) | The RestrictedModelsResponse object returned by the operation. | [optional]
