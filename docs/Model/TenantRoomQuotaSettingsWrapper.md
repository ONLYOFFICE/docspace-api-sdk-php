...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\TenantRoomQuotaSettings**](TenantRoomQuotaSettings.md) | The TenantRoomQuotaSettings object returned by the operation. | [optional]
