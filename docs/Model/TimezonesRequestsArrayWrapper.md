...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\TimezonesRequestsDto[]**](TimezonesRequestsDto.md) | The list of TimezonesRequestsDto objects returned by the operation. | [optional]
