...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\UsageSpaceStatItemDto[]**](UsageSpaceStatItemDto.md) | The list of UsageSpaceStatItemDto objects returned by the operation. | [optional]
