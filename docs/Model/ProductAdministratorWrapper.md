...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\ProductAdministratorDto**](ProductAdministratorDto.md) | The ProductAdministratorDto object returned by the operation. | [optional]
