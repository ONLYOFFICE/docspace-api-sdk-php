...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\WebhooksConfigWithStatusDto[]**](WebhooksConfigWithStatusDto.md) | The list of WebhooksConfigWithStatusDto objects returned by the operation. | [optional]
