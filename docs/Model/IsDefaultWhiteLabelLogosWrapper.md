...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\IsDefaultWhiteLabelLogosDto**](IsDefaultWhiteLabelLogosDto.md) | The IsDefaultWhiteLabelLogosDto object returned by the operation. | [optional]
