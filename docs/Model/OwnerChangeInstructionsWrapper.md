...
------------ | ------------- | ------------- | -------------
**response** | [**\OpenAPI\Client\Model\OwnerChangeInstructionsDto**](OwnerChangeInstructionsDto.md) | The OwnerChangeInstructionsDto object returned by the operation. | [optional]
