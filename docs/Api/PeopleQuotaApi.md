...
```php
resetUsersQuota($update_members_quota_request_dto): \OpenAPI\Client\Model\EmployeeFullArrayWrapper
```
...
| ------------- | ------------- | ------------- | ------------- |
| **update_members_quota_request_dto** | [**\OpenAPI\Client\Model\UpdateMembersQuotaRequestDto**](../Model/UpdateMembersQuotaRequestDto.md)|  | [optional] |
...
$update_members_quota_request_dto = new \OpenAPI\Client\Model\UpdateMembersQuotaRequestDto(); // \OpenAPI\Client\Model\UpdateMembersQuotaRequestDto

try {
    $result = $apiInstance->resetUsersQuota($update_members_quota_request_dto);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling QuotaApi->resetUsersQuota: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateUserQuota($update_members_quota_request_dto): \OpenAPI\Client\Model\EmployeeFullArrayWrapper
```
...
try {
    $result = $apiInstance->updateUserQuota($update_members_quota_request_dto);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling QuotaApi->updateUserQuota: ', $e->getMessage(), PHP_EOL;
}
```
