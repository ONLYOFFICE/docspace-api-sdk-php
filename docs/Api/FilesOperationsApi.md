...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **in_dto** | [**\OpenAPIClientModelBatchRequestDto**](../Model/.md)| The request parameters for copying/moving files. | [optional] |
...
$in_dto = new \OpenAPI\Client\Model\\OpenAPIClientModelBatchRequestDto(); // \OpenAPIClientModelBatchRequestDto | The request parameters for copying/moving files.
...
```php
emptyTrash($single, $folder_type): \OpenAPI\Client\Model\FileOperationArrayWrapper
```
...
| **folder_type** | [**int[]**](../Model/int.md)| The parent folder types used to empty the trash only from the items originally located in the sections of the specified types. | [optional] |
...
$folder_type = [2]; // int[] | The parent folder types used to empty the trash only from the items originally located in the sections of the specified types.

try {
    $result = $apiInstance->emptyTrash($single, $folder_type);
    print_r($result);
} catch (Exception $e) {
