...
```php
getAiUserSettings(): \OpenAPI\Client\Model\AiUserSettingsWrapper
```
...
[**\OpenAPI\Client\Model\AiUserSettingsWrapper**](../Model/AiUserSettingsWrapper.md)
...
try {
    $result = $apiInstance->getAiUserSettings();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SettingsApi->getAiUserSettings: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
setAiUserSettings($set_ai_user_settings_request_dto): \OpenAPI\Client\Model\AiUserSettingsWrapper
```
...
| ------------- | ------------- | ------------- | ------------- |
| **set_ai_user_settings_request_dto** | [**\OpenAPI\Client\Model\SetAiUserSettingsRequestDto**](../Model/SetAiUserSettingsRequestDto.md)|  | [optional] |
...
$set_ai_user_settings_request_dto = new \OpenAPI\Client\Model\SetAiUserSettingsRequestDto(); // \OpenAPI\Client\Model\SetAiUserSettingsRequestDto

try {
    $result = $apiInstance->setAiUserSettings($set_ai_user_settings_request_dto);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SettingsApi->setAiUserSettings: ', $e->getMessage(), PHP_EOL;
}
```
