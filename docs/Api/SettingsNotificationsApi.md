# onlyoffice/docspace-api-sdk.OpenAPI\Client\Api.NotificationsApi
...
$type = 0; // \OpenAPI\Client\Model\NotificationType | The type of notification to query, specified in the route.
