# onlyoffice/docspace-api-sdk.OpenAPI\Client\Api.SecurityApi
...
$ids = ["item1","item2"]; // string[] | The list of module identifiers for which to retrieve the security settings.
