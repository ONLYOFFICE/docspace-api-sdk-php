...
class FoldersApi
{
     ...
     *
     * @param  int $folder_id The folder ID whose history is exported. (required)
     * @param  \OpenAPI\Client\Model\AuditReportFormat|null $format The output file format of the report. Defaults to XLSX. (optional)
     * @param  \DateTime|null $from The start date of the history period to export. (optional)
     * @param  \DateTime|null $to The end date of the history period to export. (optional)
    ...
    {
        list($response) = $this->createReportFolderHistoryWithHttpInfo($folder_id, $format, $from, $to, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->createReportFolderHistoryRequest($folder_id, $format, $from, $to, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createReportFolderHistoryAsync($folder_id, $format = null, $from = null, $to = null, string $contentType = self::contentTypes['createReportFolderHistory'][0])
    {
        return $this->createReportFolderHistoryAsyncWithHttpInfo($folder_id, $format, $from, $to, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createReportFolderHistoryAsyncWithHttpInfo($folder_id, $format = null, $from = null, $to = null, string $contentType = self::contentTypes['createReportFolderHistory'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createReportFolderHistoryRequest($folder_id, $format = null, $from = null, $to = null, string $contentType = self::contentTypes['createReportFolderHistory'][0])
    {
    ...
    /**
     * Operation generateXlsxByFolder
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateXlsxByFolder'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->generateXlsxByFolderWithHttpInfo($folder_id, $contentType);
        return $response;
    }

    /**
     * Operation generateXlsxByFolderWithHttpInfo
     *
     * Generate XLSX report by folder
     *
     * REST API Reference for generateXlsxByFolder Operation
    ...
    {
        $request = $this->generateXlsxByFolderRequest($folder_id, $contentType);
    ...
    /**
     * Operation generateXlsxByFolderAsync
     *
     * Generate XLSX report by folder
     *
     * REST API Reference for generateXlsxByFolder Operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateXlsxByFolderAsync($folder_id, string $contentType = self::contentTypes['generateXlsxByFolder'][0])
    {
        return $this->generateXlsxByFolderAsyncWithHttpInfo($folder_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation generateXlsxByFolderAsyncWithHttpInfo
     *
     * Generate XLSX report by folder
     *
     * REST API Reference for generateXlsxByFolder Operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateXlsxByFolderAsyncWithHttpInfo($folder_id, string $contentType = self::contentTypes['generateXlsxByFolder'][0])
    {
    ...
    /**
     * Create request for operation 'generateXlsxByFolder'
     *
     * @param  int $folder_id The folder unique identifier. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateXlsxByFolder'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function generateXlsxByFolderRequest($folder_id, string $contentType = self::contentTypes['generateXlsxByFolder'][0])
    {

        // verify the required parameter 'folder_id' is set
        if ($folder_id === null || (is_array($folder_id) && count($folder_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $folder_id when calling generateXlsxByFolder'
            );
        }


        $resourcePath = '/api/2.0/files/folder/{folderId}/xlsx';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  int[]|null $folder_type The parent folder types used to filter the folder contents by folder type. (optional)
     ...
     * @param  bool|null $with_sub_folders Specifies whether to include files from subfolders in the results. (optional)
    ...
    {
        list($response) = $this->getFolderByFolderIdWithHttpInfo($folder_id, $user_id_or_group_id, $shared_by, $filter_type, $room_id, $folder_type, $exclude_subject, $apply_filter_option, $with_sub_folders, $extension, $search_area, $forms_item_key, $forms_item_type, $count, $start_index, $sort_by, $sort_order, $filter_value, $location, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getFolderByFolderIdRequest($folder_id, $user_id_or_group_id, $shared_by, $filter_type, $room_id, $folder_type, $exclude_subject, $apply_filter_option, $with_sub_folders, $extension, $search_area, $forms_item_key, $forms_item_type, $count, $start_index, $sort_by, $sort_order, $filter_value, $location, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFolderByFolderIdAsync($folder_id, $user_id_or_group_id = null, $shared_by = null, $filter_type = null, $room_id = null, $folder_type = null, $exclude_subject = null, $apply_filter_option = null, $with_sub_folders = null, $extension = null, $search_area = null, $forms_item_key = null, $forms_item_type = null, $count = null, $start_index = null, $sort_by = null, $sort_order = null, $filter_value = null, $location = null, string $contentType = self::contentTypes['getFolderByFolderId'][0])
    {
        return $this->getFolderByFolderIdAsyncWithHttpInfo($folder_id, $user_id_or_group_id, $shared_by, $filter_type, $room_id, $folder_type, $exclude_subject, $apply_filter_option, $with_sub_folders, $extension, $search_area, $forms_item_key, $forms_item_type, $count, $start_index, $sort_by, $sort_order, $filter_value, $location, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFolderByFolderIdAsyncWithHttpInfo($folder_id, $user_id_or_group_id = null, $shared_by = null, $filter_type = null, $room_id = null, $folder_type = null, $exclude_subject = null, $apply_filter_option = null, $with_sub_folders = null, $extension = null, $search_area = null, $forms_item_key = null, $forms_item_type = null, $count = null, $start_index = null, $sort_by = null, $sort_order = null, $filter_value = null, $location = null, string $contentType = self::contentTypes['getFolderByFolderId'][0])
    {
        $returnType = '\OpenAPI\Client\Model\FolderContentIntegerWrapper';
        $request = $this->getFolderByFolderIdRequest($folder_id, $user_id_or_group_id, $shared_by, $filter_type, $room_id, $folder_type, $exclude_subject, $apply_filter_option, $with_sub_folders, $extension, $search_area, $forms_item_key, $forms_item_type, $count, $start_index, $sort_by, $sort_order, $filter_value, $location, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFolderByFolderIdRequest($folder_id, $user_id_or_group_id = null, $shared_by = null, $filter_type = null, $room_id = null, $folder_type = null, $exclude_subject = null, $apply_filter_option = null, $with_sub_folders = null, $extension = null, $search_area = null, $forms_item_key = null, $forms_item_type = null, $count = null, $start_index = null, $sort_by = null, $sort_order = null, $filter_value = null, $location = null, string $contentType = self::contentTypes['getFolderByFolderId'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $with_sub_folders,
            'withSubFolders', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     * @param  \OpenAPI\Client\Model\SortOrder|null $sort_order The order in which the results are sorted. (optional)
     * @param  string|null $filter_value The text used as a filter or search criterion for folder content queries. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getFormsFolder'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\FolderContentIntegerWrapper
    ...
    {
        list($response) = $this->getFormsFolderWithHttpInfo($user_id_or_group_id, $filter_type, $count, $start_index, $sort_by, $sort_order, $filter_value, $contentType);
        return $response;
    }

    /**
     * Operation getFormsFolderWithHttpInfo
     *
     * Get the Forms section
     *
     * REST API Reference for getFormsFolder Operation
    ...
    {
        $request = $this->getFormsFolderRequest($user_id_or_group_id, $filter_type, $count, $start_index, $sort_by, $sort_order, $filter_value, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFormsFolderAsync($user_id_or_group_id = null, $filter_type = null, $count = null, $start_index = null, $sort_by = null, $sort_order = null, $filter_value = null, string $contentType = self::contentTypes['getFormsFolder'][0])
    {
        return $this->getFormsFolderAsyncWithHttpInfo($user_id_or_group_id, $filter_type, $count, $start_index, $sort_by, $sort_order, $filter_value, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFormsFolderAsyncWithHttpInfo
     *
     * Get the Forms section
     *
     * REST API Reference for getFormsFolder Operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFormsFolderAsyncWithHttpInfo($user_id_or_group_id = null, $filter_type = null, $count = null, $start_index = null, $sort_by = null, $sort_order = null, $filter_value = null, string $contentType = self::contentTypes['getFormsFolder'][0])
    {
        $returnType = '\OpenAPI\Client\Model\FolderContentIntegerWrapper';
        $request = $this->getFormsFolderRequest($user_id_or_group_id, $filter_type, $count, $start_index, $sort_by, $sort_order, $filter_value, $contentType);
    ...
    /**
     * Create request for operation 'getFormsFolder'
     *
     * @param  string|null $user_id_or_group_id The user or group ID. (optional)
     * @param  \OpenAPI\Client\Model\FilterType|null $filter_type The filter type. (optional)
     * @param  int|null $count The maximum number of items to retrieve in the request. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFormsFolderRequest($user_id_or_group_id = null, $filter_type = null, $count = null, $start_index = null, $sort_by = null, $sort_order = null, $filter_value = null, string $contentType = self::contentTypes['getFormsFolder'][0])
    {



        if ($count !== null && $count > 100) {
            throw new \InvalidArgumentException('invalid value for "$count" when calling FoldersApi.getFormsFolder, must be smaller than or equal to 100.');
        }
        if ($count !== null && $count < 1) {
            throw new \InvalidArgumentException('invalid value for "$count" when calling FoldersApi.getFormsFolder, must be bigger than or equal to 1.');
        }
        ...
        $resourcePath = '/api/2.0/files/@forms';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getReportFolderHistory
     *
    ...
    {
        list($response) = $this->getReportFolderHistoryWithHttpInfo($folder_id, $contentType);
        return $response;
    }

    /**
     * Operation getReportFolderHistoryWithHttpInfo
     *
     * Get the folder history report generation status
     *
     * REST API Reference for getReportFolderHistory Operation
    ...
    {
        $request = $this->getReportFolderHistoryRequest($folder_id, $contentType);
    ...
    /**
     * Operation getReportFolderHistoryAsync
     *
     * Get the folder history report generation status
     *
     * REST API Reference for getReportFolderHistory Operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReportFolderHistoryAsync($folder_id, string $contentType = self::contentTypes['getReportFolderHistory'][0])
    {
        return $this->getReportFolderHistoryAsyncWithHttpInfo($folder_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getReportFolderHistoryAsyncWithHttpInfo
     *
     * Get the folder history report generation status
     *
     * REST API Reference for getReportFolderHistory Operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReportFolderHistoryAsyncWithHttpInfo($folder_id, string $contentType = self::contentTypes['getReportFolderHistory'][0])
    {
        $returnType = '\OpenAPI\Client\Model\DocumentBuilderTaskWrapper';
        $request = $this->getReportFolderHistoryRequest($folder_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getReportFolderHistoryRequest($folder_id, string $contentType = self::contentTypes['getReportFolderHistory'][0])
    {

        // verify the required parameter 'folder_id' is set
        if ($folder_id === null || (is_array($folder_id) && count($folder_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $folder_id when calling getReportFolderHistory'
            );
        }
    ...
    /**
     * Operation terminateReportFolderHistory
     *
     ...
     * @return void
     */
    public function terminateReportFolderHistory($folder_id, string $contentType = self::contentTypes['terminateReportFolderHistory'][0])
    {
        $this->terminateReportFolderHistoryWithHttpInfo($folder_id, $contentType);
    }

    /**
     * Operation terminateReportFolderHistoryWithHttpInfo
     *
     * Terminate the folder history report generation
     *
     * REST API Reference for terminateReportFolderHistory Operation
     ...
     */
    public function terminateReportFolderHistoryWithHttpInfo($folder_id, string $contentType = self::contentTypes['terminateReportFolderHistory'][0])
    {
        $request = $this->terminateReportFolderHistoryRequest($folder_id, $contentType);
    ...
    /**
     * Operation terminateReportFolderHistoryAsync
     *
     * Terminate the folder history report generation
     *
     * REST API Reference for terminateReportFolderHistory Operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function terminateReportFolderHistoryAsync($folder_id, string $contentType = self::contentTypes['terminateReportFolderHistory'][0])
    {
        return $this->terminateReportFolderHistoryAsyncWithHttpInfo($folder_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation terminateReportFolderHistoryAsyncWithHttpInfo
     *
     * Terminate the folder history report generation
     *
     * REST API Reference for terminateReportFolderHistory Operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function terminateReportFolderHistoryAsyncWithHttpInfo($folder_id, string $contentType = self::contentTypes['terminateReportFolderHistory'][0])
    {
        $returnType = '';
        $request = $this->terminateReportFolderHistoryRequest($folder_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function terminateReportFolderHistoryRequest($folder_id, string $contentType = self::contentTypes['terminateReportFolderHistory'][0])
    {

        // verify the required parameter 'folder_id' is set
        if ($folder_id === null || (is_array($folder_id) && count($folder_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $folder_id when calling terminateReportFolderHistory'
            );
        }
     ...
     * @param  bool|null $create_new_if_exist Specifies whether to create the new file if it already exists or not. (optional)
     * @param  bool|null $store_original_file Specifies whether to upload documents in the original formats as well or not. (optional)
     * @param  bool|null $keep_convert_status Specifies whether to keep the file converting status or not. (optional)
    ...
    {
        list($response) = $this->uploadFileWithHttpInfo($folder_id, $create_new_if_exist, $store_original_file, $keep_convert_status, $file, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->uploadFileRequest($folder_id, $create_new_if_exist, $store_original_file, $keep_convert_status, $file, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadFileAsync($folder_id, $create_new_if_exist = null, $store_original_file = null, $keep_convert_status = null, $file = null, string $contentType = self::contentTypes['uploadFile'][0])
    {
        return $this->uploadFileAsyncWithHttpInfo($folder_id, $create_new_if_exist, $store_original_file, $keep_convert_status, $file, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadFileAsyncWithHttpInfo($folder_id, $create_new_if_exist = null, $store_original_file = null, $keep_convert_status = null, $file = null, string $contentType = self::contentTypes['uploadFile'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadFileRequest($folder_id, $create_new_if_exist = null, $store_original_file = null, $keep_convert_status = null, $file = null, string $contentType = self::contentTypes['uploadFile'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $create_new_if_exist,
            'createNewIfExist', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $store_original_file,
            'storeOriginalFile', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $keep_convert_status,
            'keepConvertStatus', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    {
        list($response) = $this->uploadFileToMyWithHttpInfo($create_new_if_exist, $store_original_file, $keep_convert_status, $file, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->uploadFileToMyRequest($create_new_if_exist, $store_original_file, $keep_convert_status, $file, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadFileToMyAsync($create_new_if_exist = null, $store_original_file = null, $keep_convert_status = null, $file = null, string $contentType = self::contentTypes['uploadFileToMy'][0])
    {
        return $this->uploadFileToMyAsyncWithHttpInfo($create_new_if_exist, $store_original_file, $keep_convert_status, $file, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadFileToMyAsyncWithHttpInfo($create_new_if_exist = null, $store_original_file = null, $keep_convert_status = null, $file = null, string $contentType = self::contentTypes['uploadFileToMy'][0])
    {
        $returnType = '\OpenAPI\Client\Model\FileIntegerArrayWrapper';
        $request = $this->uploadFileToMyRequest($create_new_if_exist, $store_original_file, $keep_convert_status, $file, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadFileToMyRequest($create_new_if_exist = null, $store_original_file = null, $keep_convert_status = null, $file = null, string $contentType = self::contentTypes['uploadFileToMy'][0])
    {
