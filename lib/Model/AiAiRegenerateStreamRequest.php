...
/**
 * AiAiRegenerateStreamRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AiAiRegenerateStreamRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'aiAiRegenerateStream_request';
     ...
     * Sets thread_id
     *
     * @param string $thread_id Target thread (must already exist).
     *
     * @return self
     */
