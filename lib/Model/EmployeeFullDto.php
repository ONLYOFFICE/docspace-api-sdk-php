...
class EmployeeFullDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets display_name
     *
     * @param string|null $display_name The HTML-encoded user's display name formatted according to the default format for the current culture.
     *
     * @return self
     */
    ...
    public function setHasPersonalFolder($has_personal_folder)
    {
        if (is_null($has_personal_folder)) {
            array_push($this->openAPINullablesSetToNull, 'has_personal_folder');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('has_personal_folder', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
