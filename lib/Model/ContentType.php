...
class ContentType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('boundary', $data ?? [], null);
        $this->setIfExists('char_set', $data ?? [], null);
    ...
    */
     ...
     * Sets boundary
     *
     * @param string|null $boundary boundary
     *
     * @return self
     */
    ...
    {
        if (is_null($boundary)) {
            array_push($this->openAPINullablesSetToNull, 'boundary');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('boundary', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets char_set
     *
     * @param string|null $char_set char_set
     *
     * @return self
     */
    ...
    {
        if (is_null($char_set)) {
            array_push($this->openAPINullablesSetToNull, 'char_set');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('char_set', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
