 ...
 *
 * @category Class
 * @description The successful API response containing the list of EmployeeFullDto objects.
...
class EmployeeFullArrayWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\EmployeeFullDto[]|null $response The list of EmployeeFullDto objects returned by the operation.
     *
     * @return self
     */
