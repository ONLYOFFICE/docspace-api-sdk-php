...
/**
 * AiToolsSetDisabledRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AiToolsSetDisabledRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'aiToolsSetDisabled_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tool_names', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tool_names'] === null) {
            $invalidProperties[] = "'tool_names' can't be null";
        }
    ...
    {
        return $this->container['tool_names'];
    }

    /**
     * Sets tool_names
     *
     * @param string[] $tool_names Tool names to disable.
     *
     * @return self
     */
    public function setToolNames($tool_names)
    {
        if (is_null($tool_names)) {
            throw new \InvalidArgumentException('non-nullable tool_names cannot be null');
        }
        $this->container['tool_names'] = $tool_names;
