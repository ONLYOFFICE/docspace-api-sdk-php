...
/**
 * FileShareResponseArrayWrapper Class Doc Comment
 *
 * @category Class
 * @description The successful API response containing the list of FileShare objects.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FileShareResponseArrayWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FileShareResponseArrayWrapper';
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\FileShare[]',
        'count' => 'int',
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\FileShare[]|null $response The list of FileShare objects returned by the operation.
     *
     * @return self
     */
