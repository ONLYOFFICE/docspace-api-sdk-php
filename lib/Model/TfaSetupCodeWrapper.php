...
/**
 * TfaSetupCodeWrapper Class Doc Comment
 *
 * @category Class
 * @description The successful API response containing the TfaSetupCodeDto object.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TfaSetupCodeWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TfaSetupCodeWrapper';
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\TfaSetupCodeDto',
        'count' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\TfaSetupCodeDto|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\TfaSetupCodeDto|null $response The TfaSetupCodeDto object returned by the operation.
     *
     * @return self
     */
