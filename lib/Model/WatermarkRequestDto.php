...
/**
 * WatermarkRequestDto Class Doc Comment
 *
 * @category Class
 * @description The request parameters for adding watermarks.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WatermarkRequestDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WatermarkRequestDto';
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Specifies whether watermarks are on or off.
     *
     * @return self
     */
     ...
     * Gets additions
     *
     * @return \OpenAPI\Client\Model\WatermarkAdditions|null
     */
     ...
     * Sets additions
     *
     * @param \OpenAPI\Client\Model\WatermarkAdditions|null $additions Specifies whether to display the following addditional information or not: username, user email, user IP address, current date and room name.
     *
     * @return self
     */
    ...
    public function setText($text)
    {
        ...
        if (!is_null($text) && (mb_strlen($text) > 255)) {
            throw new \InvalidArgumentException('invalid length for $text when calling WatermarkRequestDto., must be smaller than or equal to 255.');
        }
        if (!is_null($text) && (mb_strlen($text) < 0)) {
            throw new \InvalidArgumentException('invalid length for $text when calling WatermarkRequestDto., must be bigger than or equal to 0.');
        }
     ...
     * Sets rotate
     *
     * @param int|null $rotate The watermark text and image rotate angle.
     *
     * @return self
     */
     ...
     * Sets image_scale
     *
     * @param int|null $image_scale The watermark image scale.
     *
     * @return self
     */
     ...
     * Sets image_url
     *
     * @param string|null $image_url The path to the temporary image file.
     *
     * @return self
     */
     ...
     * Sets image_height
     *
     * @param float|null $image_height The watermark image height.
     *
     * @return self
     */
     ...
     * Sets image_width
     *
     * @param float|null $image_width The watermark image width.
     *
     * @return self
     */
