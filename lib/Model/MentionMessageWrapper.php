...
class MentionMessageWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets action_link
     *
     * @param \OpenAPI\Client\Model\ActionLinkConfig|null $action_link The config parameter which contains the information about the action in the document that will be scrolled to.
     *
     * @return self
     */
    ...
    public function setMessage($message)
    {
        ...
        if (!is_null($message) && (mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling MentionMessageWrapper., must be smaller than or equal to 255.');
        }
        if (!is_null($message) && (mb_strlen($message) < 0)) {
            throw new \InvalidArgumentException('invalid length for $message when calling MentionMessageWrapper., must be bigger than or equal to 0.');
        }
