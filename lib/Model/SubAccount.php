 ...
 *
 * @category Class
 * @description Represents a sub-account with a specific currency and balance.
...
class SubAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets currency
     *
     * @param string|null $currency The three-character ISO 4217 currency symbol of the sub-account.
     *
     * @return self
     */
