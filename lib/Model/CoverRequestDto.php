...
/**
 * CoverRequestDto Class Doc Comment
 *
 * @category Class
 * @description The request parameters to change the room cover.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CoverRequestDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CoverRequestDto';
     ...
     * Sets color
     *
     * @param string|null $color The cover color.
     *
     * @return self
     */
    public function setColor($color)
    {
        ...
        if (!is_null($color) && (!preg_match("/^([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling CoverRequestDto., must conform to the pattern /^([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/.");
        }
     ...
     * Sets cover
     *
     * @param string|null $cover The cover name.
     *
     * @return self
     */
