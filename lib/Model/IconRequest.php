 ...
 */
class IconRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IconRequest';
    ...
    */
     ...
     * Sets icon
     *
     * @param string|null $icon Group icon
     *
     * @return self
     */
