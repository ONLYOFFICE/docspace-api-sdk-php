 ...
 *
 * @category Class
 * @description The successful API response containing the ReportDto object.
...
class ReportWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\ReportDto|null $response The ReportDto object returned by the operation.
     *
     * @return self
     */
