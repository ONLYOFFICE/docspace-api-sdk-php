...
/**
 * BackupsCountResultDto Class Doc Comment
 *
 * @category Class
 ...
 */
class BackupsCountResultDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BackupsCountResultDto';
     ...
     * Sets free
     *
     * @param int|null $free The number of free backups.
     *
     * @return self
     */
     ...
     * Sets paid
     *
     * @param int|null $paid The number of paid backups.
     *
     * @return self
     */
