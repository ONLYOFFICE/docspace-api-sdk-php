 ...
 */
class AiAiSendStreamBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AiAiSendStreamBody';
     ...
     * Sets thread_id
     *
     * @param string|null $thread_id Target thread; a new one is created (with an auto title) when omitted.
     *
     * @return self
     */
