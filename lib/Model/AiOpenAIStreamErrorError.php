 ...
 */
class AiOpenAIStreamErrorError implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AiOpenAIStreamError_error';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['param'] === null && !$this->isNullableSetToNull('param')) {
            $invalidProperties[] = "'param' is required";
        }
