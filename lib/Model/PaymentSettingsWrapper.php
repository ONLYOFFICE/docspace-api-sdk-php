 ...
 *
 * @category Class
 * @description The successful API response containing the PaymentSettingsDto object.
...
class PaymentSettingsWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\PaymentSettingsDto|null $response The PaymentSettingsDto object returned by the operation.
     *
     * @return self
     */
