...
/**
 * AppArrayWrapper Class Doc Comment
 *
 * @category Class
 * @description The successful API response containing the list of AppDto objects.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AppArrayWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AppArrayWrapper';
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\AppDto[]',
        'count' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\AppDto[]|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\AppDto[]|null $response The list of AppDto objects returned by the operation.
     *
     * @return self
     */
