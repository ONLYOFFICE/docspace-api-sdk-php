...
/**
 * AiProfilesListProviderModelsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AiProfilesListProviderModelsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'aiProfilesListProviderModels_request';
     ...
     * Sets provider_type
     *
     * @param \OpenAPI\Client\Model\AiProviderType $provider_type Provider whose catalog to list.
     *
     * @return self
     */
     ...
     * Sets base_url
     *
     * @param string $base_url Provider API base URL.
     *
     * @return self
     */
