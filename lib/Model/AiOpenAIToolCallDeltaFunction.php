 ...
 */
class AiOpenAIToolCallDeltaFunction implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AiOpenAIToolCallDelta_function';
