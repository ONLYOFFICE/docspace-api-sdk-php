 ...
 *
 * @category Class
 * @description The successful API response containing the AppDto object.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AppWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AppWrapper';
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\AppDto|null $response The AppDto object returned by the operation.
     *
     * @return self
     */
