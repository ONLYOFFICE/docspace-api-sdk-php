 ...
 *
 * @category Class
 * @description The successful API response containing the DocServiceUrlDto object.
...
class DocServiceUrlWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DocServiceUrlDto|null $response The DocServiceUrlDto object returned by the operation.
     *
     * @return self
     */
