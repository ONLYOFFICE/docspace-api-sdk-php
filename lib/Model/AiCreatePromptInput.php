...
/**
 * AiCreatePromptInput Class Doc Comment
 *
 * @category Class
 * @description Input for creating a prompt — the engine generates `id`/`createdAt`/`updatedAt`.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AiCreatePromptInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AiCreatePromptInput';
