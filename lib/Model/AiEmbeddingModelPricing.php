...
/**
 * AiEmbeddingModelPricing Class Doc Comment
 *
 * @category Class
 * @description The pricing of a single embedding model.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AiEmbeddingModelPricing implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AiEmbeddingModelPricing';
    ...
    protected static $openAPITypes = [
        ...
        'provider' => 'string',
        'link' => 'string',
        'price' => '\OpenAPI\Client\Model\AiEmbeddingPrice'
    ];
    ...
    {
        if (is_null($owned_by)) {
            array_push($this->openAPINullablesSetToNull, 'owned_by');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('owned_by', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets price
     *
     * @return \OpenAPI\Client\Model\AiEmbeddingPrice
     */
     ...
     * Sets price
     *
     * @param \OpenAPI\Client\Model\AiEmbeddingPrice $price The price of an embedding model, per token.
     *
     * @return self
     */
