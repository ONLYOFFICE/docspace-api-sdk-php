...
/**
 * OrdersItemRequestDtoInteger Class Doc Comment
 *
 * @category Class
 * @description An item in the ordering request with its entry type and ID.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrdersItemRequestDtoInteger implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OrdersItemRequestDtoInteger';
    ...
    protected static $openAPITypes = [
        'entry_id' => 'int',
        'entry_type' => '\OpenAPI\Client\Model\FileEntryType',
        'order' => 'int'
    ];
     ...
     * Sets entry_id
     *
     * @param int $entry_id The entry unique identifier (file or folder).
     *
     * @return self
     */
     ...
     * Gets entry_type
     *
     * @return \OpenAPI\Client\Model\FileEntryType
     */
     ...
     * Sets entry_type
     *
     * @param \OpenAPI\Client\Model\FileEntryType $entry_type The entry type (file or folder).
     *
     * @return self
     */
    ...
    public function setOrder($order)
    {
        ...
        if (($order > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $order when calling OrdersItemRequestDtoInteger., must be smaller than or equal to 2147483647.');
        }
        if (($order < 1)) {
            throw new \InvalidArgumentException('invalid value for $order when calling OrdersItemRequestDtoInteger., must be bigger than or equal to 1.');
        }
