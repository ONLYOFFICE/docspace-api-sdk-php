 ...
 *
 * @category Class
 * @description The successful API response containing the list of CompanyWhiteLabelSettings objects.
...
class CompanyWhiteLabelSettingsArrayWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\CompanyWhiteLabelSettings[]|null $response The list of CompanyWhiteLabelSettings objects returned by the operation.
     *
     * @return self
     */
