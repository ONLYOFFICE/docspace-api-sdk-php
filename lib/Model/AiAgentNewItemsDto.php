...
/**
 * AiAgentNewItemsDto Class Doc Comment
 *
 * @category Class
 ...
 */
class AiAgentNewItemsDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AiAgentNewItemsDto';
    ...
    protected static $openAPITypes = [
        'agent' => '\OpenAPI\Client\Model\AiFileEntryBaseDto',
        'items' => '\OpenAPI\Client\Model\AiFileEntryBaseDto[]'
    ];
     ...
     * Gets agent
     *
     * @return \OpenAPI\Client\Model\AiFileEntryBaseDto
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\AiFileEntryBaseDto[]|null $items The list of file entry items.
     *
     * @return self
     */
