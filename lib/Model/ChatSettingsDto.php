...
/**
 * ChatSettingsDto Class Doc Comment
 *
 * @category Class
 * @description The chat settings parameters.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ChatSettingsDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ChatSettingsDto';
    ...
    protected static $openAPITypes = [
        ...
        'model_alias' => 'string',
        'prompt' => 'string',
        'multimodal' => '\OpenAPI\Client\Model\ChatMultimodalSettingsDto',
        'thinking' => 'bool',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('model_alias', $data ?? [], null);
     ...
     * Sets provider_id
     *
     * @param int|null $provider_id The AI provider ID.
     *
     * @return self
     */
     ...
     * Sets model_id
     *
     * @param string|null $model_id The AI model ID used for chat completions.
     *
     * @return self
     */
    ...
    {
        return $this->container['model_alias'];
    }

    /**
     * Sets model_alias
     *
     * @param string|null $model_alias The AI model display alias.
     *
     * @return self
     */
    public function setModelAlias($model_alias)
    {
        if (is_null($model_alias)) {
            array_push($this->openAPINullablesSetToNull, 'model_alias');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('model_alias', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['model_alias'] = $model_alias;
     ...
     * Sets prompt
     *
     * @param string|null $prompt The system prompt for the chat.
     *
     * @return self
     */
     ...
     * Gets multimodal
     *
     * @return \OpenAPI\Client\Model\ChatMultimodalSettingsDto|null
     */
     ...
     * Sets multimodal
     *
     * @param \OpenAPI\Client\Model\ChatMultimodalSettingsDto|null $multimodal multimodal
     *
     * @return self
     */
     ...
     * Sets thinking
     *
     * @param bool|null $thinking Indicates whether the model supports extended thinking mode.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets internal
     *
     * @param bool|null $internal Indicates whether this is an internal AI gateway provider.
     *
     * @return self
     */
