 ...
 *
 * @category Class
 * @description The successful API response containing the FolderDtoString object.
...
class FolderStringWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\FolderDtoString|null $response The FolderDtoString object returned by the operation.
     *
     * @return self
     */
