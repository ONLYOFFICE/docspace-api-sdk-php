...
/**
 * DocsCloudIpFilterRule Class Doc Comment
 *
 * @category Class
 * @description Represents the IP filter rule of a DocsCloud tenant.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DocsCloudIpFilterRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DocsCloudIpFilterRule';
     ...
     * Sets address
     *
     * @param string|null $address The IP address.
     *
     * @return self
     */
    public function setAddress($address)
    {
        ...
        if (!is_null($address) && (mb_strlen($address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address when calling DocsCloudIpFilterRule., must be smaller than or equal to 255.');
        }
        if (!is_null($address) && (mb_strlen($address) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address when calling DocsCloudIpFilterRule., must be bigger than or equal to 0.');
        }
     ...
     * Sets allowed
     *
     * @param bool|null $allowed Whether the IP address is allowed.
     *
     * @return self
     */
