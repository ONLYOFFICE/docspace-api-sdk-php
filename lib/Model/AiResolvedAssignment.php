...
/**
 * AiResolvedAssignment Class Doc Comment
 *
 * @category Class
 * @description Resolved profile for an action — both the storage row and its ID.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AiResolvedAssignment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AiResolvedAssignment';
