...
/**
 * AiToolsAddCustomServerRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AiToolsAddCustomServerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'aiToolsAddCustomServer_request';
     ...
     * Sets name
     *
     * @param string $name Server name (unique within scope).
     *
     * @return self
     */
     ...
     * Sets config
     *
     * @param object $config Server transport configuration.
     *
     * @return self
     */
