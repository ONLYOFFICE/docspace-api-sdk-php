 ...
 *
 * @category Class
 * @description AI model metadata. Describes a single model available from a provider.
...
class AiModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'provider' => '\OpenAPI\Client\Model\AiProviderType',
        'reasoning' => 'bool',
        'capabilities' => 'float'
    ];
     ...
     * Sets id
     *
     * @param string $id Model identifier as used by the provider API (e.g. `gpt-4o`, `claude-sonnet-4-20250514`).
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Human-readable model name for display in the UI.
     *
     * @return self
     */
     ...
     * Sets provider
     *
     * @param \OpenAPI\Client\Model\AiProviderType $provider Provider that offers this model.
     *
     * @return self
     */
     ...
     * Sets reasoning
     *
     * @param bool|null $reasoning Whether this model supports extended thinking / chain-of-thought reasoning.
     *
     * @return self
     */
