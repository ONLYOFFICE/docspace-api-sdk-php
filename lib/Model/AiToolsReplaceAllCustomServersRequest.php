...
/**
 * AiToolsReplaceAllCustomServersRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AiToolsReplaceAllCustomServersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'aiToolsReplaceAllCustomServers_request';
     ...
     * Sets map
     *
     * @param array<string,object> $map Full replacement set, keyed by server name.
     *
     * @return self
     */
