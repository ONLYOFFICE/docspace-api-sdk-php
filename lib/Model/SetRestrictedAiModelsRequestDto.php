...
/**
 * SetRestrictedAiModelsRequestDto Class Doc Comment
 *
 * @category Class
 * @description The request parameters for setting restricted AI models.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SetRestrictedAiModelsRequestDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SetRestrictedAiModelsRequestDto';
     ...
     * Sets models
     *
     * @param string[] $models The set of restricted AI model IDs.
     *
     * @return self
     */
