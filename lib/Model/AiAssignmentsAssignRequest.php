...
/**
 * AiAssignmentsAssignRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AiAssignmentsAssignRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'aiAssignmentsAssign_request';
     ...
     * Sets action_type
     *
     * @param \OpenAPI\Client\Model\AiActionType $action_type Action the assignment applies to.
     *
     * @return self
     */
     ...
     * Sets profile_id
     *
     * @param string $profile_id Profile id to bind.
     *
     * @return self
     */
