...
/**
 * ThumbnailsDataDto Class Doc Comment
 *
 * @category Class
 * @description The thumbnails data parameters.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ThumbnailsDataDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThumbnailsDataDto';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('retina', $data ?? [], null);
    ...
    */
     ...
     * Sets original
     *
     * @param string|null $original The thumbnail original photo.
     *
     * @return self
     */
    ...
    {
        return $this->container['retina'];
    }

    /**
     * Sets retina
     *
     * @param string|null $retina The thumbnail retina.
     *
     * @return self
     */
    ...
    {
        if (is_null($retina)) {
            array_push($this->openAPINullablesSetToNull, 'retina');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('retina', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['retina'] = $retina;
     ...
     * Sets max
     *
     * @param string|null $max The thumbnail maximum size photo.
     *
     * @return self
     */
     ...
     * Sets big
     *
     * @param string|null $big The thumbnail big size photo.
     *
     * @return self
     */
    ...
    {
        if (is_null($big)) {
            array_push($this->openAPINullablesSetToNull, 'big');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('big', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets medium
     *
     * @param string|null $medium The thumbnail medium size photo.
     *
     * @return self
     */
     ...
     * Sets small
     *
     * @param string|null $small The thumbnail small size photo.
     *
     * @return self
     */
