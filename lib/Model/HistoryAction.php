...
/**
 * HistoryAction Class Doc Comment
 *
 * @category Class
 ...
 */
class HistoryAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'HistoryAction';
    ...
    protected static $openAPITypes = [
        'id' => '\OpenAPI\Client\Model\MessageAction',
        'key' => 'string'
    ];
     ...
     * Sets id
     *
     * @param \OpenAPI\Client\Model\MessageAction|null $id id
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string|null $key The action performed on the file.
     *
     * @return self
     */
