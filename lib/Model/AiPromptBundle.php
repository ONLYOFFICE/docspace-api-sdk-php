...
/**
 * AiPromptBundle Class Doc Comment
 *
 * @category Class
 * @description Versioned, self-contained bundle of every saved prompt and folder. Stable wire format — `version` lets the import path migrate older shapes if the schema ever changes.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AiPromptBundle implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AiPromptBundle';
    ...
    protected static $openAPITypes = [
        'version' => 'float',
        'folders' => '\OpenAPI\Client\Model\AiPromptFolder[]',
        'prompts' => '\OpenAPI\Client\Model\AiPrompt[]'
    ];
     ...
     * Gets folders
     *
     * @return \OpenAPI\Client\Model\AiPromptFolder[]
     */
     ...
     * Gets prompts
     *
     * @return \OpenAPI\Client\Model\AiPrompt[]
     */
