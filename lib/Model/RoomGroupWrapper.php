...
/**
 * RoomGroupWrapper Class Doc Comment
 *
 * @category Class
 * @description The successful API response containing the RoomGroupDto object.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RoomGroupWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RoomGroupWrapper';
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\RoomGroupDto',
        'count' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\RoomGroupDto|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\RoomGroupDto|null $response The RoomGroupDto object returned by the operation.
     *
     * @return self
     */
