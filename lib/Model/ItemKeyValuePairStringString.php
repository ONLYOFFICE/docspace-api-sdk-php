 ...
 */
class ItemKeyValuePairStringString implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemKeyValuePairStringString';
