...
/**
 * FilesStatisticsFolder Class Doc Comment
 *
 * @category Class
 * @description The file statictics folder parameters.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FilesStatisticsFolder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FilesStatisticsFolder';
    ...
    */
     ...
     * Sets used_space
     *
     * @param int|null $used_space The used space in the folder.
     *
     * @return self
     */
