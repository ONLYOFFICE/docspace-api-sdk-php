 ...
 *
 * @category Class
 * @description The account information parameters.
...
class AccountInfoDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets provider
     *
     * @param string|null $provider The account provider.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The account URL.
     *
     * @return self
     */
     ...
     * Sets linked
     *
     * @param bool $linked Specifies if an account is linked with other profiles or not.
     *
     * @return self
     */
