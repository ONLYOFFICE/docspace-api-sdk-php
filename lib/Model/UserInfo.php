...
class UserInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets sid
     *
     * @param string|null $sid The LDAP user identifier.
     *
     * @return self
     */
     ...
     * Sets sso_name_id
     *
     * @param string|null $sso_name_id The SSO SAML user identifier.
     *
     * @return self
     */
     ...
     * Sets sso_session_id
     *
     * @param string|null $sso_session_id The SSO SAML user session identifier.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $check_activation Indicates whether the activation status of the employee or recipient is unchecked or inactive.  Depending on the context, this property evaluates the activation or eligibility status accordingly.
     *
     * @return self
     */
