...
/**
 * AiProviderArrayWrapper Class Doc Comment
 *
 * @category Class
 ...
 */
class AiProviderArrayWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AiProviderArrayWrapper';
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\AiProviderDto[]',
        'count' => 'int',
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\AiProviderDto[]|null $response response
     *
     * @return self
     */
