...
/**
 * AiFolderIntegerWrapper Class Doc Comment
 *
 * @category Class
 * @description The successful API response containing the FolderDtoInteger object.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AiFolderIntegerWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AiFolderIntegerWrapper';
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\AiFolderDtoInteger',
        'count' => 'int',
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\AiFolderDtoInteger|null $response The FolderDtoInteger object returned by the operation.
     *
     * @return self
     */
