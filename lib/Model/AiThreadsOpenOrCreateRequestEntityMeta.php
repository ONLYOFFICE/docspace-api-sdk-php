...
/**
 * AiThreadsOpenOrCreateRequestEntityMeta Class Doc Comment
 *
 * @category Class
 * @description Optional entity hint (lib 0.5.64): only `entityId` is read; the pair is re-resolved server-side before reaching the provider as metadata.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AiThreadsOpenOrCreateRequestEntityMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'aiThreadsOpenOrCreate_request_entityMeta';
