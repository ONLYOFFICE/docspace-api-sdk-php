...
/**
 * DoubleNullableWrapper Class Doc Comment
 *
 * @category Class
 * @description The successful API response containing the double value.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DoubleNullableWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DoubleNullableWrapper';
     ...
     * Sets response
     *
     * @param float|null $response The double value returned by the operation.
     *
     * @return self
     */
