...
/**
 * ExchangeToken200Response Class Doc Comment
 *
 * @category Class
 ...
 */
class ExchangeToken200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'exchangeToken_200_response';
    ...
    */
     ...
     * Sets token_type
     *
     * @param string|null $token_type The type of token issued, typically 'Bearer'.
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in The number of seconds until the access token expires.
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token The token used to obtain a new access token when the current one expires.
     *
     * @return self
     */
