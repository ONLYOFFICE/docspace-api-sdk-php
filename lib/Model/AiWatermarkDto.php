...
/**
 * AiWatermarkDto Class Doc Comment
 *
 * @category Class
 ...
 */
class AiWatermarkDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AiWatermarkDto';
    ...
    protected static $openAPITypes = [
        'additions' => '\OpenAPI\Client\Model\AiWatermarkAdditions',
        'text' => 'string',
        'rotate' => 'int',
        'image_scale' => 'int',
        'image_url' => 'string',
     ...
     * Gets additions
     *
     * @return \OpenAPI\Client\Model\AiWatermarkAdditions
     */
     ...
     * Sets additions
     *
     * @param \OpenAPI\Client\Model\AiWatermarkAdditions $additions Specifies whether to display in the watermark: username, user email, user ip-adress, current date, and room name.
     *
     * @return self
     */
