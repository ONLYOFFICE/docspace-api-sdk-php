...
/**
 * PageableModificationResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class PageableModificationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageableModificationResponse';
    ...
    */
     ...
     * Sets data
     *
     * @param object|null $data The paginated modification data.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_modified_on The date when the user consent was last modified.
     *
     * @return self
     */
