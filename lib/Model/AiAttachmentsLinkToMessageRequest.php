...
/**
 * AiAttachmentsLinkToMessageRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AiAttachmentsLinkToMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'aiAttachmentsLinkToMessage_request';
     ...
     * Sets ids
     *
     * @param string[] $ids Attachment ids to bind.
     *
     * @return self
     */
     ...
     * Sets message_id
     *
     * @param string $message_id Owning message id.
     *
     * @return self
     */
     ...
     * Sets thread_id
     *
     * @param string $thread_id Owning thread id.
     *
     * @return self
     */
