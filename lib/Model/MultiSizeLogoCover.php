 ...
 */
class MultiSizeLogoCover implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MultiSizeLogoCover';
     ...
     * Sets data
     *
     * @param array<string,string>|null $data The logo cover data.
     *
     * @return self
     */
