 ...
 */
class ItemKeyValuePairObjectObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemKeyValuePairObjectObject';
