...
/**
 * AiThreadsAppendUserMessageRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AiThreadsAppendUserMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'aiThreadsAppendUserMessage_request';
     ...
     * Sets message
     *
     * @param \OpenAPI\Client\Model\AiThreadMessageLike $message Message to persist (id/createdAt are storage-assigned).
     *
     * @return self
     */
