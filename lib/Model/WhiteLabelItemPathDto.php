...
/**
 * WhiteLabelItemPathDto Class Doc Comment
 *
 * @category Class
 * @description The white label item path parameters.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WhiteLabelItemPathDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhiteLabelItemPathDto';
    ...
    */
     ...
     * Sets light
     *
     * @param string|null $light The path to the light theme logo.
     *
     * @return self
     */
     ...
     * Sets dark
     *
     * @param string|null $dark The path to the dark theme logo.
     *
     * @return self
     */
